    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float3 voronoi(float2 uv)
            {
                ...
                // Edge difference between F2 and F1 (small near cell boundaries).
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // Edge mask smoothstep for soft edges
